...
useEffect(() => {
  ...
  return (
    <>
      {/* ================= HERO SECTION ================= */}
      <section className="relative bg-[#AFE1AF] text-white py-16 sm:py-20 md:py-24 overflow-hidden">
        {/* <ThreeJSBackground /> */}
        <ThreeJSBackground scale={isMobile ? 0.5 : 1} />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 items-center">
            ...
            {/* LEFT */}
            <div className="space-y-6 sm:space-y-8 max-w-full md:max-w-[560px]">

              {/* STATIC LINE */}
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-[#0F3D2E]">
                Innovative Solutions for
              </h1>
              ...
              <div className="relative w-full overflow-hidden">
                {/* Invisible placeholder (locks width) */}
                <div className="opacity-0 pointer-events-none text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold whitespace-nowrap">
                  Production Optimization
                </div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-[#0F3D2E]/90 leading-relaxed">
                Providing cutting-edge engineering consultancy and customized
                software solutions for the oil and gas industry since 2015.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                <Link
                  to="/schedule-demo"
                  className="w-full sm:w-auto text-center bg-white text-[#0F3D2E] px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:bg-[#AFE1AF] transition shadow-md"
                >
                  Book a Demo
                </Link>
                ...
                <Link
                  to="/services"
                  className="w-full sm:w-auto text-center border-2 border-white text-white hover:bg-[#AFE1AF] hover:text-[#0F3D2E] px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold transition"
                >
                  Our Services
                </Link>
              </div>
            ...
            {/* RIGHT VIDEO (UNCHANGED & PRESERVED) */}
            {/*
            <div className="relative w-full max-w-xl mx-auto">
              <div className="relative aspect-video overflow-hidden rounded-2xl shadow-2xl bg-black/10 ring-4 ring-[#AFE1AF]/40">
                <iframe
      ...
      {/* ================= G.O.T.S SECTION ================= */}
      <section className="bg-[#AFE1AF]/20 py-14 sm:py-16 md:py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">

          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0F3D2E] mb-4">
            Our Core Values
          </h2>

          <p className="text-base sm:text-lg text-[#0F3D2E]/80 mb-8">
            Built on a strong foundation that drives excellence and sustainability
          </p>

          <div className="inline-block w-full sm:w-auto bg-white px-6 sm:px-10 py-6 sm:py-8 rounded-2xl shadow-xl border border-[#AFE1AF]">

            <h3 className="text-2xl sm:text-3xl font-extrabold text-[#0F3D2E] tracking-widest mb-3">
              G.O.T.S
            </h3>

            <p className="text-xl sm:text-2xl font-semibold text-[#0F3D2E] caret min-h-[40px]">
              {gotsText}
            </p>

            <p className="mt-4 text-[#0F3D2E]/70 text-sm sm:text-base">
              Growth · Operational Excellence · Technology · Sustainability
            </p>
