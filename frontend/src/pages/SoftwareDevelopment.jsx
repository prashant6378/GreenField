...
export default function SoftwareDevelopment() {
    ...
    const heroBackgroundUrl = asset("/images/backgrounds/software.png");
    const featureImageUrl = asset("/images/software.png");
    ...
    return (
        <main className={`${NAV_TOP_PADDING} bg-gray-50 text-slate-800 min-h-screen`}>
            ...
            <header className="relative">
                <div
                    className="min-h-[65vh] md:h-96 rounded-b-2xl md:rounded-b-3xl overflow-hidden relative shadow-xl"
                    style={heroStyle}
                >
                    <div className="absolute inset-0 bg-black/40" />
                    ...
                    <div className="absolute inset-0 flex items-center z-20">
                        <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
                            <div className="text-white max-w-3xl py-10 md:py-0">

                                <h1
                                    ref={heroTitleRef}
                                    className="text-2xl sm:text-3xl md:text-5xl font-extrabold leading-tight drop-shadow-lg"
                                >
                                    Software Engineering
                                </h1>
                                ...
                                <p
                                    ref={heroSubRef}
                                    className="mt-4 text-sm sm:text-base md:text-lg text-white/90 max-w-xl"
                                >
                                    Custom engineering software for upstream oil & gas — from SandMaster to integrated workflows and data platforms.
                                </p>
            ...
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12 py-16">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <article className="lg:col-span-8 space-y-10" ref={contentRef}>
                        ...
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold" style={{ color: PRIMARY_COLOR }}>
                        ...
                        <figure className="mb-8 overflow-hidden rounded-2xl shadow-lg border border-gray-100">
                            <img
                                ...
                                onError={(e) => {
                                    e.currentTarget.style.display = "none";
                                    e.currentTarget.parentElement.style.backgroundColor = PRIMARY_COLOR;
                                    e.currentTarget.parentElement.innerHTML = '<div class="flex items-center justify-center h-56 sm:h-64 md:h-96 text-white text-xl font-bold">Dashboard Image Unavailable</div>';
                                }}
                            />
                        </figure>

                        <p className="text-lg sm:text-xl text-slate-600 leading-relaxed border-l-4 border-[#1B4D3E] pl-4 bg-white p-4 rounded-xl shadow-sm">
                            We bridge the gap between complex petroleum engineering science and modern, intuitive software design. Our applications are built for performance, security, and seamless integration into existing enterprise environments.
                        </p>

                        <section className="pt-4">
                            <h3 className="text-xl sm:text-2xl font-bold mb-6" style={{ color: PRIMARY_COLOR }}>
                                What We Build
                            </h3>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#1B4D3E]">
                                    ...
                                    <p className="text-sm text-slate-600">
                                        Automation and data handoffs that reduce manual engineering load and improve reliability.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#1B4D3E]">
                                    ...
                                    <p className="text-sm text-slate-600">
                                        Secure, scalable applications built on modern cloud infrastructure (CI/CD, Kubernetes).
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-[#1B4D3E]">
                                    ...
                                    <p className="text-sm text-slate-600">
                                        Intuitive, estimated vs actual reporting and advanced visualization dashboards.
                                    </p>
                                </div>
                            </div>
                        </section>
                    ...
                    <aside className="lg:col-span-4">
                        <div className="sticky top-28 space-y-8">
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                                ...
                                <div className="flex flex-col gap-3 text-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-slate-500">Sales Inquiries</span>
                                            <a href="mailto:sales@greenfield.energy" className="font-semibold text-slate-800 hover:text-[#1B4D3E]">
                                                sales@greenfield.energy
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-slate-500">General Line</span>
                                            <a href="tel:+919876543210" className="font-semibold text-slate-800 hover:text-[#1B4D3E]">
                                                +91 98765 43210
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                                ...
                                <ul className="space-y-3 text-slate-700">
                                    <li className="flex items-center gap-3">
                                        <ChevronRight className="w-4 h-4 text-[#1B4D3E]" />
                                        <a href="/services/oil-gas" className="hover:text-[#1B4D3E] font-medium">Oil &amp; Gas Consultancy</a>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <ChevronRight className="w-4 h-4 text-[#1B4D3E]" />
                                        <a href="/services/training" className="hover:text-[#1B4D3E] font-medium">Technical Training</a>
                                    </li>
                                    <li className="flex items-center gap-3">
                                        <ChevronRight className="w-4 h-4 text-[#1B4D3E]" />
                                        <a href="/services/data-analysis" className="hover:text-[#1B4D3E] font-medium">Data Analysis &amp; Modeling</a>
                                    </li>
                                </ul>
                            </div>
