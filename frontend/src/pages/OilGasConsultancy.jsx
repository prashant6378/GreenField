...
export default function OilGasConsultancy() {
  ...
  return (
    <main className={`${NAV_TOP_PADDING} bg-white text-slate-800 min-h-screen`}>
      ...
      <header className="relative">
        <div
          className="min-h-[70vh] md:h-[480px] rounded-b-2xl md:rounded-b-3xl overflow-hidden relative shadow-lg"
          style={heroStyle}
        >
          <div className="absolute inset-0 bg-black/40 z-10" />
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
              <div className="text-white max-w-3xl py-10 md:py-0">
                <h1
                  ref={heroTitleRef}
                  style={{ opacity: 0 }}
                  className="text-3xl sm:text-4xl md:text-6xl font-extrabold leading-tight drop-shadow-xl"
                >
                  Strategic Advisory for the Future of Energy
                </h1>
                ...
                <p
                  style={{ opacity: 0 }}
                  className="mt-4 text-sm sm:text-base md:text-lg text-white/90 max-w-2xl font-light"
                >
                  Integrated upstream solutions — reservoir optimization, production efficiency, sand management and commercial advisory.
                </p>
          ...
          <article ref={contentRef} className="lg:col-span-8 space-y-10">
            ...
            <figure className="mb-6 overflow-hidden rounded-2xl shadow-xl">
              <img
                src={asset("/images/oilandgas.png")}
                alt="oil infrastructure"
                className="w-full h-56 sm:h-64 md:h-96 object-cover rounded-2xl"
                onError={(e) => {
                  e.currentTarget.style.display = "none";
                  e.currentTarget.parentElement.style.background = "#e8f5e9";
                  e.currentTarget.parentElement.style.minHeight = "220px";
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="/brochures/Integrated-Sand-Management_Brochure_Rev-Sep2021.pdf"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-white shadow-sm border border-gray-200 text-[#1B4D3E] hover:bg-[#AFE1AF] transition"
              >
                <DownloadCloud className="w-4 h-4" /> Download Full Brochure
              </a>
            </div>
            ...
            <div className="sticky top-28 space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                ...
                <div className="text-sm text-slate-700 space-y-2">
                  <div className="flex items-center gap-3">
                    <Mail className="w-4 h-4 text-[#84A98C]" />
                    <a href="mailto:support@greenfield.energy" className="font-medium text-slate-800 hover:text-[#1B4D3E]">
                      support@greenfield.energy
                    </a>
                  </div>
                  <div className="flex items-center gap-3">
                    <Phone className="w-4 h-4 text-[#84A98C]" />
                    <a href="tel:+919876543210" className="font-medium text-slate-800 hover:text-[#1B4D3E]">
                      +91 98765 43210
                    </a>
                  </div>
                </div>
